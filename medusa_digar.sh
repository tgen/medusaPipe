       ...
       if [[ "$digar" != "yes" ]] ; then
        ...
        star) echo "star case"
            ...
            do
                ...
                echo "qsub -A $debit -l nodes=1:ppn=$nCores -v FASTQ1=$read1Name,FASTQ2=$read2Name,SAMNAME=$samName,TRINITYPATH=$trinityPath,DIGARPATH=$digarPath,ANN=$digarAnn,SAMTOOLSPATH=$samtoolsPath,BWAPATH=$bwaPath,GENENAME=$geneName,DIGARDIR=$digarDir,REF=$ref,BAM=$starBam,GTF=$gtf,RUNDIR=$runDir,D=$d $pbsHome/medusa_digar.pbs"
