#!/usr/bin/env bash
#SBATCH --job-name="medusa_FScuffDiff"
...
perf stat ${CUFFDIFFPATH}/cuffdiff -p 16 -N -M ${MASK} -b ${REF} --library-type fr-secondstrand -L Control,Tumor ${GTF} ${BAM1} ${BAM2} 2> ${DIRNAME}.cuffDiff.perfOut
if [ $? -eq 0 ] ; then
