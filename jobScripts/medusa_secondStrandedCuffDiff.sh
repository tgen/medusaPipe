#!/usr/bin/env bash
#SBATCH --job-name="medusa_SScuffDiff"
...
perf stat ${CUFFDIFFPATH}/cuffdiff -p 16 -N -M ${MASK} -b ${REF} --library-type fr-firststrand -L Control,Tumor ${GTF} ${BAM1} ${BAM2} 2> ${DIRNAME}.cuffDiff.perfOut
if [ $? -eq 0 ] ; then
