...
thisStep="medusa_nextJob_rnaMarkDup.txt"
nxtStep1="medusa_nextJob_IGLbedCov.txt"
...
do
    ...
    *) echo "### I should not be here"
    ...
    sbatch -n 1 -N 1 --cpus-per-task $nCores --output $runDir/oeFiles/%x-slurm-%j.out --export ALL,REF=$ref,OUTPUTBAM=$mdBam,REFFLAT=$refFlat,RIBINTS=$ribInts,PICARDPATH=$picardPath,BAMFILE=$rnaBam,RUNDIR=$runDir,NXT1=$nxtStep1,NXT2=$nxtStep2,NXT3=$nxtStep3,NXT4=$nxtStep4,D=$d $pbsHome/medusa_rnaMarkDup.pbs
    if [ $? -eq 0 ] ; then
