                ...
                if [ $skipGroup -ne 1 ] ; then
                    ...
                    do
                        ...
                        do
                            ...
                            qsub -A $debit -l nodes=1:ppn=$nCores -v GATKPATH=$gatkPath,INTS=$irIntMiniFile,IRBAMFILE=$irBamMiniFile,D=$d,INDELS=$indels,REF=$ref,BAMFILE=$bamMiniName,RUNDIR=$runDir,NXT1=$nxtStep1,D=$d $pbsHome/medusa_indelRealign.pbs
                            if [ $? -eq 0 ] ; then
