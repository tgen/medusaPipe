...
do
    ...
    qsub -A $debit -l nodes=1:ppn=$nCores -v PICARDPATH=$picardPath,BAMFILE=$bamName,NXT1=$nxtStep1,NXT2=$nxtStep2,NXT3=$nxtStep3,NXT4=$nxtStep4,NXT5=$nxtStep5,NXT6=$nxtStep6,NXT7=$nxtStep7,RUNDIR=$runDir,OUTPUTBAM=$mdBamFile,D=$d $pbsHome/medusa_markDups.pbs
    if [ $? -eq 0 ] ; then
