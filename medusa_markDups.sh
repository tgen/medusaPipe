...
thisStep="medusa_nextJob_markDups.txt"
nxtStep1="medusa_nextJob_jointIR.txt"
#nxtStep2="medusa_nextJob_unifiedGenotyper.txt"
nxtStep2="medusa_nextJob_haplotypeCaller.txt"
nxtStep3="medusa_nextJob_picardMultiMetrics.txt"
nxtStep4="medusa_nextJob_samtoolsStats.txt"
...
do
    ...
    sbatch -n 1 -N 1 --cpus-per-task $nCores --mem-per-cpu 3G --output $runDir/oeFiles/%x-slurm-%j.out --export ALL,PICARDPATH=$picardPath,BAMFILE=$bamName,NXT1=$nxtStep1,NXT2=$nxtStep2,NXT3=$nxtStep3,NXT4=$nxtStep4,NXT5=$nxtStep5,NXT6=$nxtStep6,NXT7=$nxtStep7,RUNDIR=$runDir,OUTPUTBAM=$mdBamFile,D=$d $pbsHome/medusa_markDups.sh
    if [ $? -eq 0 ] ; then
